      ...
      <nav>
        ...
        <article>
          <section>
            ...
            <h1>About</h1>
            <p>Tennis is a beautiful sport which fosters fantastic qualities in its players. Needing to utilize both mental prowess and mastery over their emotions in addition to the baseline physicality, tennis players are often regarded as one fo the most well rounded athletes in the world. </p>
            ...
            <table class = "center">
				...
				<?php foreach($pros as $pro){ ?>
					<tr>
						...
						<td><?php echo htmlspecialchars($pro["Slams"]); ?></td>
					<tr>
				<?php } ?>
